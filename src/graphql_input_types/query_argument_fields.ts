...
// Enum values for key_type
export type KeyTypeEnum =
  | "name"
  | "i64"
  | "i128"
  | "i256"
...
// Enum values for encode_type
export type EncodeTypeEnum = "dec" | "hex";

export interface QueryArguments {
  scope?: string;
  index_position?: number;
  key_type?: KeyTypeEnum;
  encode_type?: EncodeTypeEnum;
  upper_bound?: string;
  lower_bound?: string;
  limit?: number;
  reverse?: boolean;
...
const key_type_enum_type = new GraphQLEnumType({
  name: "key_type_enum",
  description:
    "Primary only supports i64. All others support i64, i128, i256, float64, float128, ripemd160, sha256.",
  values: {
