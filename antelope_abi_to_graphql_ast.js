 ...
 * @returns {Obejct} Struct AST that will be consumed by `antelope_abi_to_graphql_ast`.
 * @ignore
 */
 ...
 * @param {object} abi Antelope smart contract Application Binary interface (ABI).
 * @returns {object} a GraphQL AST for a given smart contract.
 */
function antelope_abi_to_graphql_ast(abi) {
 ...
 * @param {string} [account_name] Antelope account name.
...
module.exports = { get_graphql_fields_from_AST, antelope_abi_to_graphql_ast }
