import { GraphQLError, GraphQLBoolean, GraphQLInt, GraphQLList, GraphQLNonNull, GraphQLObjectType, GraphQLString } from "graphql";
...
const account_auth_permission_type = new GraphQLObjectType({
...
const accounts_auth_type = new GraphQLObjectType({
...
const self_delegated_bandwidth_type = new GraphQLObjectType({
...
const refund_request_type = new GraphQLObjectType({
...
const voter_info_type = new GraphQLObjectType({
...
const pair_time_point_sec_int64_type = new GraphQLObjectType({
...
const rex_info_type = new GraphQLObjectType({
    name: "rex_info_type",
    fields: {
