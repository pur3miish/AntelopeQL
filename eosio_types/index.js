...
const bytes = require('./bytes_type.js')
const extended_asset = require('./extended_asset_type.js')
...
const symbol_code = require('./symbol_code_type.js')
const symbol = require('./symbol_type.js')
const time_point_sec = require('./time_point_sec_type.js')
const time_point = require('./time_point_type.js')
const varint32 = require('./varint32_type.js')
const varuint32 = require('./varuint32_type.js')
